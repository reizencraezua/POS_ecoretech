...
@section('title', 'Edit Layout Fee')
@section('page-title', 'Edit Layout Fee Setting')
@section('page-description', 'Update layout fee setting information')
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-gray-900">Edit Layout Fee Setting</h2>
            </div>
        </div>
        
        <form method="POST" action="{{ route('admin.layout-fees.update', $layoutFee) }}" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="setting_name" id="setting_name" value="{{ old('setting_name', $layoutFee->setting_name) }}" required
                ...
                <div>
                    ...
                    <select name="layout_fee_type" id="layout_fee_type" required
                        ...
                        <option value="fixed" {{ old('layout_fee_type', $layoutFee->layout_fee_type) == 'fixed' ? 'selected' : '' }}>Fixed Amount</option>
                        <option value="percentage" {{ old('layout_fee_type', $layoutFee->layout_fee_type) == 'percentage' ? 'selected' : '' }}>Percentage</option>
                    </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="layout_fee_amount" id="layout_fee_amount" value="{{ old('layout_fee_amount', $layoutFee->layout_fee_amount) }}" required
                               step="0.01" min="0"
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                              ...
                              placeholder="Enter description for this layout fee setting">{{ old('description', $layoutFee->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $layoutFee->is_active) ? 'checked' : '' }}
            ...
            <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Update Layout Fee
                </button>
            </div>
        </form>
    </div>
