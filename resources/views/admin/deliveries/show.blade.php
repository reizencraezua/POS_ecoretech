        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.deliveries.index') }}" class="text-gray-500 hover:text-gray-700 transition-colors">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('admin.orders.show', $delivery->order_id) }}" class="text-sm text-maroon hover:text-red-700 font-medium">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <div class="p-4 space-y-3">
                    <a href="{{ route('admin.deliveries.edit', $delivery) }}" class="w-full bg-gray-100 hover:bg-gray-200 text-gray-900 px-3 py-2 rounded text-sm transition-colors inline-flex items-center justify-center">
                        Edit Delivery
                    </a>
                    <button type="button" 
                            onclick="if(confirm('Are you sure you want to archive this delivery?')) { document.getElementById('archive-form').submit(); }"
                            class="w-full w-full bg-red-100 hover:bg-red-200 text-red-900 px-3 py-2 rounded text-sm transition-colors inline-flex items-center justify-center ">
                        Archive
                    </button>
                    <form id="archive-form" method="POST" action="{{ route('admin.deliveries.archive', $delivery) }}" class="hidden">
                        @csrf
                    </form>
                </div>
            </div>
