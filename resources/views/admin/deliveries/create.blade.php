...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Schedule Delivery</h1>
            <p class="text-gray-600 mt-2">Create a new delivery schedule</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.deliveries.store') }}" method="POST" class="space-y-6">
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 mb-4 border-b border-gray-200 pb-2">Delivery Information</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="delivery_address" id="delivery_address" rows="3" required
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-maroon focus:border-maroon @error('delivery_address') border-red-500 @enderror">{{ old('delivery_address') }}</textarea>
