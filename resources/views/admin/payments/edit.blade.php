        ...
        <form action="{{ route('admin.payments.update', $payment) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <!-- Remarks -->
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 mb-3">Additional Information</h3>
                        <div>
                ...
                <!-- Right Column: Info Boxes (1/3 width) -->
                <div class="lg:col-span-1 space-y-4">
                    
                    <!-- Maximum Payment Information -->
                    <div id="max_payment_info" class="p-4 bg-green-50 border border-green-200 rounded-lg text-sm">
                        <div class="flex items-center text-green-700 mb-3">
                            <i class="fas fa-info-circle mr-2"></i>
                            <span class="font-semibold">Payment Info</span>
                        </div>
                        <div class="space-y-2 text-green-800">
                            ...
                            <div class="flex justify-between border-t border-green-300 pt-2">
                                <span class="font-semibold">Max Payment:</span>
                    ...
                    <div id="downpayment_info" class="p-4 bg-blue-50 border border-blue-200 rounded-lg text-sm" style="display: none;">
                        <div class="flex items-center text-blue-700 mb-3">
                            <i class="fas fa-info-circle mr-2"></i>
                            <span class="font-semibold">Downpayment Info</span>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateMaxPaymentInfo() {
        ...
        if (selectedOrder && orderAmounts[selectedOrder]) {
            ...
            // Add visual indicator if payment exceeds maximum
            const maxPaymentInfo = document.getElementById('max_payment_info');
