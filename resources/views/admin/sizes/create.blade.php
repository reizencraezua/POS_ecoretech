...
@section('page-title', 'Create New Size')
@section('page-description', 'Add a new size for products and services')
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-semibold text-gray-900">Create Size</h2>
            </div>
        </div>
        
        <form method="POST" action="{{ route('admin.sizes.store') }}" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="size_name" id="size_name" value="{{ old('size_name') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="size_value" id="size_value" value="{{ old('size_value') }}"
            ...
            <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                    ...
                    <i class="fas fa-save mr-2"></i>Create Size
                </button>
            </div>
        </form>
    </div>
