                    ...
                    <dl class="space-y-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ $inventory->supplier ? $inventory->supplier->supplier_name : 'No supplier assigned' }}
                            </dd>
                        </div>
                    </dl>
                </div>
...
function openAddStockModal(inventoryId, itemName) {
    ...
    document.getElementById('addStockForm').action = `/admin/inventories/${inventoryId}/add-stock`;
...
function openUseStockModal(inventoryId, itemName, available) {
    ...
    document.getElementById('useStockForm').action = `/admin/inventories/${inventoryId}/use-stock`;
