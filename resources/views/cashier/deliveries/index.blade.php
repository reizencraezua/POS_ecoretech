        ...
        <div class="flex items-center space-x-4">
            ...
            <form method="GET" class="flex items-center space-x-2">
                ...
                @if(request('search') || request('status'))
                    <a href="{{ route('cashier.deliveries.index') }}" class="bg-gray-100 hover:bg-gray-200 px-4 py-2 rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location.href='{{ route('cashier.deliveries.show', $delivery) }}'">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
                                    @if($delivery->creator)
                                        @if($delivery->creator->employee)
                                            EMP{{ $delivery->creator->employee->employee_id }} : {{ $delivery->creator->employee->employee_firstname }}
                                        @else
