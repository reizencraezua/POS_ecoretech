                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4">
                                        <select x-model="item.size" :name="`items[${index + {{ $order->details->count() }} }][size]`" 
                                            ...
                                            <template x-if="item.type === 'service' && item.id">
                                                <template x-for="size in getAvailableServiceSizes(item.id)">
                                                    <option :value="size.size_name" x-text="size.size_name"></option>
                                                </template>
                                            </template>
                                        </select>
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('cashier.orders.show', $order) }}" class="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50">
...
function orderForm() {
    return {
        ...
        getAvailableServiceSizes(serviceId) {
