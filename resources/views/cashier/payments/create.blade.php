...
<div class="container mx-auto px-4 py-6">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('cashier.payments.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="amount_paid" id="amount_paid" value="{{ old('amount_paid') }}" step="0.01" min="0" required
                    ...
                    <div class="mt-6" id="reference_number_field" style="display: none;">
