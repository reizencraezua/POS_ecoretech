...
<div class="max-w-full mx-auto px-4">
    <div class="bg-white rounded-lg shadow-md">
        ...
        <form method="POST" action="{{ route('cashier.quotations.update', $quotation) }}" class="p-6" x-data="quotationForm()" x-init="init()" @submit="console.log('Form submitted', $data)">
            @csrf
            @method('PUT')
                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('cashier.quotations.index') }}" class="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
